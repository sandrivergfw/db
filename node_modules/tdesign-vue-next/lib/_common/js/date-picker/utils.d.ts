...
export declare function getWeeks({ year, month }: {
    year: number;
    month: number;
}, { firstDayOfWeek, showWeekOfYear, disableDate, minDate, maxDate, }: OptionsType): ({
    text: number;
    active: boolean;
    value: Date;
    disabled: boolean;
...
export declare function getQuarters(year: number, { disableDate, minDate, maxDate, quarterLocal }: OptionsType): {
    value: Date;
    now: boolean;
    disabled: boolean;
    active: boolean;
...
export declare function getYears(year: number, { disableDate, minDate, maxDate, }: OptionsType): {
    value: Date;
    now: boolean;
    disabled: boolean;
    active: boolean;
