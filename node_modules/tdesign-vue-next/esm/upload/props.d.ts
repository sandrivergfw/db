...
declare const _default: {
    ...
    dragContent: {
        type: PropType<((h: typeof import("vue").h) => import("../common").SlotReturnValue) | ((h: typeof import("vue").h, props: import("./type").TriggerContext) => import("../common").SlotReturnValue)>;
    };
    draggable: {
        type: BooleanConstructor;
        default: any;
    ...
    trigger: {
        type: PropType<(h: typeof import("vue").h, props: import("./type").TriggerContext) => import("../common").SlotReturnValue>;
    };
    triggerButtonProps: {
    ...
    onOneFileSuccess: PropType<(context: Pick<import("./type").SuccessContext, "file" | "e" | "response">) => void>;
