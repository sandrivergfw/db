          ...
          <el-col :span="15" :offset="4">
            ...
            <el-affix :offset="80">
              <el-menu
                ...
                @close="handleClose"
              >
                <el-menu-item index="1" class="selected-menu-item" @click="goOverView">
          ...
          <el-row class="content-1">
            <el-col :span="11">
              <el-row class="card-head">
                <el-col class="card-head-name" :span="8">
                  您的信息
                </el-col>
                <el-col class="card-head-link" :span="8" @click="goDetails">
                  账号详情 <i class="iconfont icon-xiangyou_right"></i>
                </el-col>
              </el-row>

              <div class="user-inf-box">
                <el-row class="user-inf">
                  <el-col class="user-inf-name" :offset="4" :span="2">
                    昵称
                  </el-col>
            ...
            <el-col :span="11" :offset="1">
              <el-row class="card-head">
                <el-col class="card-head-name" :span="24">
                  安全检查
                </el-col>
                <el-col class="card-head-link" :span="8" @click="goSecurity">
                  安全 <i class="iconfont icon-xiangyou_right"></i>
                </el-col>
              </el-row>

              <div class="user-inf-box">
                <div style="height: 180px" class="recognization-box">
          ...
          <el-row class="content-2">
            <el-col :span="23" :offset="0">
              <el-row class="card-head">
                ...
                <el-col class="card-head-link" :span="8" @click="goHistory">
                  历史订单 <i class="iconfont icon-xiangyou_right"></i>
                </el-col>
              </el-row>
...
.card-head{
  ...
  background-color: rgba(165, 166, 176, 0.805);
  .el-col {
    //color: #fff;
    color: rgb(0, 0, 0);
    text-align: center;
...
.user-inf-box {
  ...
  background-color: rgba(229, 229, 231, 0.803);
  .user-inf {
    position: relative;
    top: 15%;
    height: 50px;
